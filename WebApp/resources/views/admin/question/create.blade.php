                  ...
                  @csrf
                    <label style="display: block; margin-bottom: 10px;">
                      ...
                      <select name="test_id" style="width: 100%; height: 30px; padding: 5px; font-size: 14px;">
                        <option value="1" style="font-size: 14px; background-color: #f2f2f2; color: #333;">1</option>
                        <option value="2" style="font-size: 14px; background-color: #f2f2f2; color: #333;">2</option>
                        <option value="3" style="font-size: 14px; background-color: #f2f2f2; color: #333;">3</option>
                      </select>
                    ...
                    <input type="submit" value="Submit" style="display: block; width: 100%; padding: 10px; background-color: #4CAF50; color: white; border: none; border-radius: 4px; cursor: pointer;">
                  </form>
